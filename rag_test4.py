...
def main():
   ...
   #채팅 대화기록을 점검
    ...
    if process:
        ...
        retriever = vectorstore.as_retriever(search_type = 'mmr', vervose = True) ## vervose를 verbose로 수정
    ...
    if user_input := st.chat_input("메세지를 입력해 주세요"):
        ...
        with st.chat_message("assistant"):    
          ...
          #  llm= ChatOllama(
           #     base_url="https://more-finally-hen.ngrok-free.app/llm/")
           #vervet-simple-blowfish.ngrok-free.app
           #https://more-finally-hen.ngrok-free.app/llm/
